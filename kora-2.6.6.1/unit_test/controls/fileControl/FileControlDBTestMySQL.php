...
require_once '../controls/fileControl.php';

class FileControlDBTestMySQL extends PHPUnit_Extensions_Database_TestCase
{
	public $db;
    ...
    {   
    	...
    	$this->my_control3 = new FileControl(99, 1, "11-38-3", 4);
		$this->my_control4 = new FileControl(99, 1, "11-38-4", 4);
		$this->my_control5 = new FileControl(99, 1, "11-38-5", 4);  
    }
