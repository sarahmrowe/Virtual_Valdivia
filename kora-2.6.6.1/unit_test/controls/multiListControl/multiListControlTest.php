...
include_once ('../controls/multiListControl.php');

class MultiListControlsTest extends PHPUnit_Framework_TestCase
{
	...
	{
		$this->my_control = new MultiListControl;
//		$this->differet_control = new MultiListControl;
//		$this->my_control->MultiListControl(20, 3, 2, 1);
	}
	...
	{
		$this->assertEquals("Multi-List Control", $this->my_control->getName());
		$this->assertEquals("List (Multi-Select)", $this->my_control->getType());
	...
	/**
     	...
     	*/
	public function testTheMultiListStoredValueToDisplay2($a, $b, $c)
	{
...
/*
	public function testMultiListControlFunctionDisplayXML2()
	{
		$this->assertEquals($this->different_control->displayXML(), '');
	}
*/	
	
	public function testMultiListControlFunctionDisplayXML()
	{
